<template>
    <div data-theme="light" class="min-h-screen bg-slate-50">
      <section class="section container">
        <h1 class=" bg-[#FFFFFF] text-3xl font-bold">
          Top Job Categories to Work in Cambodia
        </h1>
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mt-10">
          ...
          <NuxtLink to="/projects" 
            ...
            <h3 class="font-semibold text-gray-800">Project, Operations Management</h3>
          </NuxtLink>
          ...
          <NuxtLink to="/procurement" 
            ...
            <h3 class="font-semibold text-gray-800">Procurement, Supply Chain</h3>
          </NuxtLink>
          ...
          <NuxtLink to="/food" 
            ...
            <h3 class="font-semibold text-gray-800">Food and cake</h3>
          </NuxtLink>
          ...
          <NuxtLink to="/management" 
            ...
            <h3 class="font-semibold text-gray-800">Management</h3>
          </NuxtLink>
          ...
          <NuxtLink to="/education" 
            ...
            <h3 class="font-semibold text-gray-800">Education, Teaching, Childcare</h3>
          </NuxtLink>
        </div>
      </section>
  </div>
